...
export const LaunchButton = ({ onClick, isLocked }: LaunchButtonProps) => {
    return (
        <button className={`button-uiverse ${isLocked ? "force-active" : ""}`} onClick={onClick}>
